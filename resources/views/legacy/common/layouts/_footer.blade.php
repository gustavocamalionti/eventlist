<section class="section section-contacts">
    <div class="container section-padding">
        <div class="row content">
            ...
            {{--
                <div
                class="effect-reveal-to-left col-12 col-lg-4 d-flex justify-content-center align-items-start flex-column">
                <h5 class="fw-bolder">TELEFONE</h5>
                <p class="m-0">(12)3456-7890</p>
                </div>
            --}}
            {{--
                <div>
                ...
                <button type="button" class="btn btn-custom btn-contact btnRegister" data-bs-toggle="modal"
