...
<div class="form-group col-12 col-md-2 mt-2">
    ...
    <select class="form-select form-select-sm select2" name="selFilterStatus" id="selFilterStatus">
        ...
        <option value="{{ \App\Libs\Enums\EnumStatusBuies::WEBHOOK_PAYMENT_SUCCEEDED }}">Recebido</option>
        <option value="{{ \App\Libs\Enums\EnumStatusBuies::WEBHOOK_PAYMENT_PROCESSING }}">Confirmado</option>
        <option value="{{ \App\Libs\Enums\EnumStatusBuies::INTERNAL_PAYMENT_WAITING }}">Aguardando</option>
        <option value="{{ \App\Libs\Enums\EnumStatusBuies::INTERNAL_PAYMENT_CREATED }}">Criado</option>
        <option value="{{ \App\Libs\Enums\EnumStatusBuies::WEBHOOK_PAYMENT_FAILED }}">Falha</option>
        <option value="{{ \App\Libs\Enums\EnumStatusBuies::WEBHOOK_PAYMENT_EXPIRED }}">Expirado</option>
        <option value="{{ \App\Libs\Enums\EnumStatusBuies::WEBHOOK_REFUND_SUCCEEDED_TOTAL }}">Reembolsado</option>
    </select>
</div>
