...
@section('content')
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4 effect-reveal-to-right">
            <div class="card shadow-default border-0 rounded-3 h-100">
                <div class="card-header">
                    <h6 class="text-center mt-1 mb-1"><i class="fas fa-check me-2"></i>Recebidas</h6>
                </div>
                <div class="card-body" style="background-color:#c8e6c9bd">
                    <h5 class="mb-1">{{ str_pad($buysReceived['qtd'], 2, '0', STR_PAD_LEFT) }} pedidos</h5>
                    <p class="mb-0 small text-muted">Valor bruto: R$ {{ number_format($buysReceived['value'], 2, ',', '.') }}
                    </p>
                    <p class="mb-0 small text-muted">Valor líquido: R$
                        {{ number_format($buysReceived['net_value'], 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 effect-reveal-to-right">
            <div class="card shadow-default border-0 rounded-3 h-100">
                <div class="card-header">
                    <h6 class="text-center mt-1 mb-1"><i class="fas fa-sync-alt me-2"></i>Confirmadas</h6>
                </div>
                <div class="card-body" style="background-color:#bbdefbc5">
                    ...
                    <p class="mb-0 small text-muted">Valor bruto: R$
                        {{ number_format($buysConfirmed['value'], 2, ',', '.') }}</p>
                    <p class="mb-0 small text-muted">Valor líquido: R$
                        {{ number_format($buysConfirmed['net_value'], 2, ',', '.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 effect-reveal-to-left">
            <div class="card shadow-default border-0 rounded-3 h-100">
                <div class="card-header">
                    <h6 class="text-center mt-1 mb-1"><i class="fas fa-ticket me-2"></i>Informações Gerais</h6>
                </div>
                <div class="card-body" style="background-color:#fff59dc2">
