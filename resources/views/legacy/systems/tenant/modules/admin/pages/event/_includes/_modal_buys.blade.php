                ...
                <nav class="mb-3">
                    <div class="nav nav-tabs" id="nav-tab{{ $item->id }}" role="tablist">
                        <button
                            ...
                            id="nav-vouchers-tab{{ $item->id }}"
                            data-bs-toggle="tab"
                            data-bs-target="#nav-vouchers{{ $item->id }}"
                            type="button"
                            role="tab"
                            aria-controls="nav-vouchers{{ $item->id }}"
                            aria-selected="true">
                            Ingressos
                        </button>
                        ...
                        <button
                            class="nav-link"
                            id="nav-emails-tab{{ $item->id }}"
                            data-bs-toggle="tab"
                            data-bs-target="#nav-emails{{ $item->id }}"
                            type="button"
                            role="tab"
                            aria-controls="nav-emails{{ $item->id }}"
                            aria-selected="false">
                            Emails
                        </button>
                        ...
                        @can("read_log_webhooks", Auth::user())
                            <button
                                class="nav-link"
                                id="nav-webhooks-tab{{ $item->id }}"
                                data-bs-toggle="tab"
                                data-bs-target="#nav-webhooks{{ $item->id }}"
                                type="button"
                                role="tab"
                                aria-controls="nav-webhooks{{ $item->id }}"
                                aria-selected="false">
                                Webhooks
                            </button>
                        @endcan
                        ...
                        <div id="divGridVoucher{{ $item->id }}">
                            <div class="mb-0">
                                <div class="table-responsive divElementGridFatherVoucher{{ $item->id }}">
                                    <table
                                        id="zero_config_voucher{{ $item->id }}"
                            ...
                            <div id="divGridWebhook{{ $item->id }}">
                                <div class="mb-0">
                                    <div class="table-responsive divElementGridFatherWebhook{{ $item->id }}">
                                        <table
                                            id="zero_config_webhook{{ $item->id }}"
                                            class="table table-sm table-striped table-hover align-middle">
                                            <thead>
                                                <tr>
