        ...
        <div class="card-body">
            ...
            <div class="card mb-0 border-top">
                <div class="card-body table-responsive divElementGridFather p-1">
                    <form method="POST" name="editAlterPassword" id="editAlterPassword"
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="cpf" id="cpf"
                                            ...
                                            value="{{ MaskFields($user->cpf, '###.###.###-##') }}" autofocus
                                            {{ $user->cpf != null ? 'disabled' : null }} inputmode="text" />
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="mb-4">
                                        ...
                                        <input id="email" type="email"
                                            ...
                                            value="{{ $user->email }}" autocomplete="email" maxlength="255" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-5">
                                    <div class="mb-4">
                                        ...
                                        <input id="name" type="text"
                                            ...
                                            value="{{ $user->name }}" autocomplete="name" maxlength="255" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-4">
                                        ...
                                        <input id="phone_cell" type="text"
                                            ...
                                            autocomplete="phone_cell" maxlength="20" data-mask-phone-cell />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input id="zipcode" type="text"
                                            ...
                                            data-mask-cep value="{{ $user->zipcode }}" />
                                    </div>
                                </div>
                                <!-- Campo Endereço -->
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input id="number" type="text"
                                            ...
                                            data-only-numbers maxlength="15" value="{{ $user->number }}" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="mb-4">
                                        ...
                                        <input id="district" type="text"
                                            ...
                                            maxlength="255" value="{{ $user->district }}" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <!-- Campo Complemento -->
                                    <div class="mb-4">
                                        ...
                                        <input id="complement" type="text"
                                            ...
                                            name="complement" maxlength="255" value="{{ $user->complement }}" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-2">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="permission_accept">
                                                ...
                                                <a href="{{ route('tenant.site.privacy.policy') }}">Política de
                                                    Privacidade.</a>
                                            </label>
                                        </div>
                                    </div>
...
@section('scripts')
    @vite(['resources/assets/systems/tenant/modules/admin/pages/profile/js/profile_maintenance.js'], 'legacy')
@endsection
