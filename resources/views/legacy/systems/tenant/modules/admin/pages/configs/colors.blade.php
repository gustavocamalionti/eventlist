    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            <form
                ...
                attr-save="{{ route("tenant.admin.config.colors.update") }}"
                attr-redirect="{{ route("tenant.admin.config.colors.index") }}">
                @csrf
                <nav>
...
@section("scripts")
    @vite(["resources/assets/systems/tenant/modules/admin/pages/configs/js/colors.js"])
@endsection
