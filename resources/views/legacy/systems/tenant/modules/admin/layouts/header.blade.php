    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto w-100 d-flex justify-content-evenly align-items-center flex-grow-1 flex-wrap">
                ...
                <li class="nav-item dropdown effect-reveal-opacity">
                    <a id="navbarDropdownLog"
                        class="nav-link text-nowrap text-truncate text-decoration-none dropdown-toggle {{ Route::is('tenant.admin.config.*') ? 'active' : '' }}"
                        href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false" v-pre>
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownLog">
                        <a class="dropdown-item {{ Route::is('tenant.admin.config.colors.index') ? 'active' : '' }}"
                            href="{{ route('tenant.admin.config.colors.index') }}">
                            Cores
                        </a>

                        <a class="dropdown-item {{ Route::is('tenant.admin.config.contents.index') ? 'active' : '' }}"
                            href="{{ route('tenant.admin.config.contents.index') }}">
                            Conteúdos do Site
                        </a>

                        <a class="dropdown-item {{ Route::is('tenant.admin.config.parameters.index') ? 'active' : '' }}"
            ...
            <ul
                ...
                @else
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown"
                            class="nav-link text-nowrap text-truncate text-decoration-none dropdown-toggle {{ Route::is('tenant.admin.profile.*') ? 'active' : '' }}"
                            href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false" v-pre>
                            {{ Auth::user()->name }}
                        </a>
