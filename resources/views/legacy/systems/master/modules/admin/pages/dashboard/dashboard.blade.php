...
@section("styles")
    @vite(["resources/assets/systems/master/modules/admin/pages/dashboard/css/dashboard.css"])
@endsection
...
@section("scripts")
    @vite(["resources/assets/systems/master/modules/admin/pages/dashboard/js/dashboard.js"])
@endsection
