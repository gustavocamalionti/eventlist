                ...
                <div class="card mb-0 border-top">
                    <div class="card-body table-responsive divElementGridFather">
                        <table id="zero_config" class="table table-sm table-striped table-hover align-middle">
                            @include('legacy.systems.master.modules.admin.pages.logs._partials._log_audits_grid')
                        </table>
                    </div>
                </div>
            </div>
...
@section('scripts')
    @vite(['resources/assets/systems/master/modules/admin/pages/logs/js/log_audits_list.js', 'resources/assets/common/js/utils/filters.js'])
@endsection
