@can('update_users', Auth::user())
    <div class="row mt-2 mb-2 ms-1">
        @can('read_users_audit', Auth::user())
            <div class="offset-1 col-4 d-flex justify-content-end align-items-center p-0"
                ...
                <!-- Modal -->
                @include('legacy.systems.master.modules.admin.layouts._modal_history', $item)
            </div>
        @endcan
                    ...
                    @can('update_users', Auth::user())
                        <li>
                            <a class="dropdown-item link-dropdown-item text-dark"
                                href="{{ url('/admin/users-manut/' . $item->id) }}" target="_blank"
