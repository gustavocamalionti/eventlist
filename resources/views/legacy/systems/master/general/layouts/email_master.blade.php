...
<body style="margin: 0; padding: 0; background-color: #ffffff; font-family: Arial, sans-serif">
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
        @include('legacy.systems.tenant.general.includes._email_space_height', ['height' => 10])
        <tr>
            <td align="center">
                <table cellpadding="0" cellspacing="0" border="0" bgcolor="#11202B"
                    ...
                    <tr>
                        <td style="text-align: center; width: 600px" colspan="3">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                @include('legacy.systems.tenant.general.layouts.email_header')
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="width: 540px; text-align: center">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                @include('legacy.systems.tenant.general.layouts.email_footer')
                            </table>
                        </td>
                        <td style="width: 30px"></td>
                    </tr>
